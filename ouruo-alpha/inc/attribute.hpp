...
public:
	...
	Health *		GetHealth() { return derivedAttributes_->health_.get(); };
	Magicka *		GetMagicka() { return derivedAttributes_->magicka_.get(); };
	Fatigue *		GetFatigue() { return derivedAttributes_->fatigue_.get(); };
	Encumbrance *	GetEncumbrance() {return derivedAttributes_->encumbrance_.get(); };
